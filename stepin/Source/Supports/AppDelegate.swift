        ...
        let config = Realm.Configuration(
            ...
            migrationBlock: { migration, oldSchemaVersion in
                if oldSchemaVersion < 3 {
                    ...
                    migration.enumerateObjects(ofType: VideoInfoTable.className()) { oldObject, newObject in
                        newObject!["cover_url"] = ""
                        newObject!["neonvideo_url"] = ""
                        newObject!["isLiked"] = false
                    }
                }
            }
        )
